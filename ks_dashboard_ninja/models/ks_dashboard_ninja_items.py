            ...
            if rec.ks_dashboard_item_type and rec.ks_dashboard_item_type != 'ks_tile' and \
                ...
                if ((rec.ks_chart_data_count_type != "count" and ks_chart_measure_field) or (
                    ...
                    if (rec.ks_chart_groupby_type == 'date_type' and rec.ks_chart_date_groupby) or \
                        ...
                        if rec.ks_chart_groupby_type == 'date_type' and rec.ks_goal_enable \
                                and rec.ks_dashboard_item_type in ['ks_bar_chart', 'ks_horizontalBar_chart',
                                                                   'ks_line_chart', 'ks_area_chart'] \
                                and rec.ks_chart_groupby_type == "date_type":
                    ...
                    if len(ks_chart_measure_field) != 0 or rec.ks_chart_data_count_type == 'count':
                        ...
                        if rec.ks_chart_relation_sub_groupby.name == rec.ks_chart_relation_groupby.name \
                                == rec.ks_sort_by_field.name:
